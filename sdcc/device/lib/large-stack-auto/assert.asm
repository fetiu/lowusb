...
; This file was generated Sun Oct 23 01:39:08 2022
;--------------------------------------------------------
	.module assert
...
;------------------------------------------------------------
;filename                  Allocated to stack - _bp -5
;linenumber                Allocated to stack - _bp -7
;expr                      Allocated to registers r5 r6 r7 
;------------------------------------------------------------
