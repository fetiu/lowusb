...
; This file was generated Sun Oct 23 01:37:46 2022
;--------------------------------------------------------
	.module _setjmp
...
;	_setjmp.c:439: return rv ? rv : 1;
	mov	a,_longjmp_PARM_2
	orl	a,(_longjmp_PARM_2 + 1)
	jz	00103$
	mov	r6,_longjmp_PARM_2
	mov	r7,(_longjmp_PARM_2 + 1)
	sjmp	00104$
00103$:
	mov	r6,#0x01
	mov	r7,#0x00
