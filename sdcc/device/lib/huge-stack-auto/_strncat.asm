...
; This file was generated Sun Oct 23 01:39:18 2022
;--------------------------------------------------------
	.module _strncat
...
;------------------------------------------------------------
;back                      Allocated to stack - _bp -6
;count                     Allocated to stack - _bp -8
;front                     Allocated to stack - _bp +1
;start                     Allocated to stack - _bp +9
