...
; This file was generated Sun Oct 23 01:39:21 2022
;--------------------------------------------------------
	.module printf_large
...
;charsOutputted            Allocated to stack - _bp +10
;fpBuffer                  Allocated to stack - _bp +11
...
;lower_case                Allocated to stack - _bp +13
;value                     Allocated to stack - _bp +14
;charsOutputted            Allocated to stack - _bp +11
;lsd                       Allocated to registers b5 
;radix                     Allocated to stack - _bp +19
;width                     Allocated to stack - _bp +20
;decimals                  Allocated to stack - _bp +21
