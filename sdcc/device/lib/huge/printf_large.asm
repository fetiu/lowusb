...
; This file was generated Sun Oct 23 01:38:27 2022
;--------------------------------------------------------
	.module printf_large
...
_output_float_negative_1_63:
	.ds 1
__print_format_left_justify_1_96:
	.ds 1
__print_format_zero_padding_1_96:
	.ds 1
__print_format_prefix_sign_1_96:
	.ds 1
__print_format_prefix_space_1_96:
	.ds 1
__print_format_signed_argument_1_96:
	.ds 1
__print_format_char_argument_1_96:
	.ds 1
__print_format_long_argument_1_96:
	.ds 1
__print_format_float_argument_1_96:
	.ds 1
__print_format_lsd_1_96:
	.ds 1
;--------------------------------------------------------
...
__print_format_PARM_4:
	.ds 1
__print_format_pfn_1_95:
	.ds 3
__print_format_radix_1_96:
	.ds 1
__print_format_width_1_96:
	.ds 1
__print_format_decimals_1_96:
	.ds 1
__print_format_length_1_96:
	.ds 1
__print_format_c_1_96:
	.ds 1
__print_format_store_4_116:
	.ds 6
__print_format_pstore_4_116:
	.ds 2
;--------------------------------------------------------
...
;	printf_large.c:206: } while (--i);
	...
	dec	a
	mov	r2,a
	mov	_calculate_digit_i_1_59,r2
	jnz	00103$
...
;	printf_large.c:247: bool negative = 0;
	clr	_output_float_negative_1_63
...
;	printf_large.c:258: negative=1;
	setb	_output_float_negative_1_63
...
;	printf_large.c:269: if (negative)
	jnb	_output_float_negative_1_63,00108$
...
;	printf_large.c:329: if (negative || sign || space)
	jb	_output_float_negative_1_63,00121$
...
;	printf_large.c:336: if (negative)
	jnb	_output_float_negative_1_63,00131$
...
;	printf_large.c:359: if (negative)
	jnb	_output_float_negative_1_63,00145$
...
;	printf_large.c:375: if (negative)
	jnb	_output_float_negative_1_63,00156$
...
;pfn                       Allocated with name '__print_format_pfn_1_95'
;radix                     Allocated with name '__print_format_radix_1_96'
;width                     Allocated with name '__print_format_width_1_96'
;decimals                  Allocated with name '__print_format_decimals_1_96'
;length                    Allocated with name '__print_format_length_1_96'
;c                         Allocated with name '__print_format_c_1_96'
;memtype                   Allocated with name '__print_format_memtype_5_113'
;store                     Allocated with name '__print_format_store_4_116'
;pstore                    Allocated with name '__print_format_pstore_4_116'
;------------------------------------------------------------
...
__print_format:
	...
	mov	r6,dph
	mov	a,dpl
	mov	dptr,#__print_format_pfn_1_95
	movx	@dptr,a
	mov	a,r6
	inc	dptr
	movx	@dptr,a
...
;	printf_large.c:479: left_justify    = 0;
	clr	__print_format_left_justify_1_96
;	printf_large.c:480: zero_padding    = 0;
	clr	__print_format_zero_padding_1_96
;	printf_large.c:481: prefix_sign     = 0;
	clr	__print_format_prefix_sign_1_96
;	printf_large.c:482: prefix_space    = 0;
	clr	__print_format_prefix_space_1_96
;	printf_large.c:483: signed_argument = 0;
	clr	__print_format_signed_argument_1_96
;	printf_large.c:484: char_argument   = 0;
	clr	__print_format_char_argument_1_96
;	printf_large.c:485: long_argument   = 0;
	clr	__print_format_long_argument_1_96
;	printf_large.c:486: float_argument  = 0;
	clr	__print_format_float_argument_1_96
;	printf_large.c:487: radix           = 0;
	mov	dptr,#__print_format_radix_1_96
	clr	a
	movx	@dptr,a
;	printf_large.c:488: width           = 0;
	mov	dptr,#__print_format_width_1_96
	movx	@dptr,a
;	printf_large.c:489: decimals        = -1;
	mov	dptr,#__print_format_decimals_1_96
	dec	a
	movx	@dptr,a
...
;	printf_large.c:493: c = *format++;
	...
	inc	dptr
	movx	@dptr,a
	mov	dptr,#__print_format_c_1_96
	mov	a,r3
	movx	@dptr,a
...
;	printf_large.c:509: zero_padding = 1;
	setb	__print_format_zero_padding_1_96
	sjmp	00101$
00107$:
...
;	printf_large.c:588: if ( ( !left_justify ) && (length < width) )
	jb	__print_format_left_justify_1_96,00286$
	mov	dptr,#__print_format_width_1_96
	movx	a,@dptr
	mov	r7,a
	clr	c
...
;	printf_large.c:603: if ( left_justify && (length < width))
	jb	__print_format_left_justify_1_96,00536$
	ljmp	00172$
00536$:
	mov	dptr,#__print_format_width_1_96
	movx	a,@dptr
...
;	printf_large.c:667: signed_argument = 1;
	setb	__print_format_signed_argument_1_96
...
;	printf_large.c:684: float_argument=1;
	setb	__print_format_float_argument_1_96
...
;	printf_large.c:693: if (float_argument)
	jnb	__print_format_float_argument_1_96,00235$
...
;	printf_large.c:713: OUTPUT_FLOAT(value.f, width, decimals, left_justify,
	...
	mov	a,r2
	movx	@dptr,a
	mov	c,__print_format_left_justify_1_96
	mov	_output_float_PARM_4,c
	mov	c,__print_format_zero_padding_1_96
	mov	_output_float_PARM_5,c
	mov	c,__print_format_prefix_sign_1_96
	mov	_output_float_PARM_6,c
	mov	c,__print_format_prefix_space_1_96
...
;	printf_large.c:726: if (char_argument)
	jnb	__print_format_char_argument_1_96,00181$
...
;	printf_large.c:729: if (!signed_argument)
	jnb	__print_format_signed_argument_1_96,00550$
	ljmp	00182$
00550$:
...
;	printf_large.c:734: else if (long_argument)
	jnb	__print_format_long_argument_1_96,00178$
...
;	printf_large.c:741: if (!signed_argument)
	jb	__print_format_signed_argument_1_96,00182$
...
;	printf_large.c:747: if ( signed_argument )
	jnb	__print_format_signed_argument_1_96,00187$
...
;	printf_large.c:756: lsd = 1;
	setb	__print_format_lsd_1_96
;	printf_large.c:758: do {
	mov	__print_format_sloc2_1_0,#(__print_format_store_4_116 + 0x0005)
	mov	(__print_format_sloc2_1_0 + 1),#((__print_format_store_4_116 + 0x0005) >> 8)
...
;	printf_large.c:765: if (!lsd)
	jb	__print_format_lsd_1_96,00189$
...
;	printf_large.c:778: if (width == 0)
	mov	dptr,#__print_format_pstore_4_116
	mov	a,__print_format_sloc2_1_0
	movx	@dptr,a
	mov	a,(__print_format_sloc2_1_0 + 1)
	inc	dptr
	movx	@dptr,a
	mov	dptr,#__print_format_length_1_96
...
;	printf_large.c:787: if (!zero_padding && !left_justify)
	jb	__print_format_zero_padding_1_96,00200$
	jb	__print_format_left_justify_1_96,00200$
...
;	printf_large.c:796: if (signed_argument) // this now means the original value was negative
	jnb	__print_format_signed_argument_1_96,00210$
...
;	printf_large.c:805: if (prefix_sign)
	jnb	__print_format_prefix_sign_1_96,00205$
...
;	printf_large.c:811: else if (prefix_space)
	jnb	__print_format_prefix_space_1_96,00211$
...
;	printf_large.c:820: if (!left_justify)
	jb	__print_format_left_justify_1_96,00219$
...
;	printf_large.c:824: OUTPUT_CHAR( zero_padding ? '0' : ' ', p );
	jnb	__print_format_zero_padding_1_96,00245$
	mov	r5,#0x30
	sjmp	00246$
00245$:
	mov	r5,#0x20
...
;	printf_large.c:840: if (!lsd)
	jb	__print_format_lsd_1_96,00222$
...
;	printf_large.c:856: if (left_justify)
	jb	__print_format_left_justify_1_96,00573$
	ljmp	00240$
00573$:
