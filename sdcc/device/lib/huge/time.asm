...
;	time.c:141: while((days += (LEAP_YEAR(year) ? 366 : 365)) <= epoch) {
	mov	_gmtime_sloc1_1_0,r4
	mov	(_gmtime_sloc1_1_0 + 1),r5
...
00119$:
	...
	mov	r0,a
	mov	a,r1
	addc	a,(_gmtime_sloc3_1_0 + 1)
	mov	r1,a
	mov	a,r2
	addc	a,(_gmtime_sloc3_1_0 + 2)
	mov	r2,a
	mov	a,r3
	addc	a,(_gmtime_sloc3_1_0 + 3)
	mov	r3,a
	mov	dptr,#_gmtime_days_1_33
	mov	a,r0
	movx	@dptr,a
...
;	time.c:142: year++;
	...
	clr	a
	cjne	a,_gmtime_sloc0_1_0,00101$
